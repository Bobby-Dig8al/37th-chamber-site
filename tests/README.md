...
| Engine logic (legality, mate, the belt ladder) | Node + the vendored `chess.js` API | ▶ next suite (see `Projects/bobby-digital-mrr-c/_team-scratch/*.mjs` for the existing logic probes) |
