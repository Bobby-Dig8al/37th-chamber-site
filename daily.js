...
const DAILY = [
  ...
  },
  {
    ...
    show:    { label:"Why We Go", name:"Cooper's creed",              work:"the explorer's faith",       why:"That we're defined by overcoming the impossible, our destiny ahead and not behind — the drive a film about equations can still make a room go silent. (A theme, not a fact.)", link:"https://en.wikipedia.org/wiki/Interstellar_(film)" }
  }
